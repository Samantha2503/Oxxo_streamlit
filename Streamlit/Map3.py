...
# --- Página: Mapa Interactivo ---
    ...
    try:
        with open("mapa_oxxo_tot.html", "r", encoding="utf-8") as f:
            html_mapa = f.read()
    ...
    # Cargar modelo
    modelo = joblib.load("xgb_final_cv_model.pkl")
...
# Título de la aplicación
    ...
    def load_model():
        try:
            model = joblib.load('xgb_final_cv_model.pkl')
            return model
